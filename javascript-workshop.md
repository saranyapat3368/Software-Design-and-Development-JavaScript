...
![s2 4 22](https://github.com/user-attachments/assets/99030216-b37f-48d7-b28f-03809a518423)
...
![s3 0](https://github.com/user-attachments/assets/ee2f5bda-1472-43f9-b4a2-8e975ebfda58)
...
<head>
    ...
    <style>
        ...
        h1 {
            color: #e91e63; /* เปลี่ยนเป็นสีชมพู */
            text-align: center;
            margin-bottom: 30px;
        }
        ...
        form {
            ...
            padding: 20px;
            border-radius: 8px;
            box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); /* เพิ่มเงาให้ฟอร์ม */
        }
        ...
        input, select {
            width: 100%;
            padding: 8px;
            border: 1px solid #e91e63; /* ขอบเป็นสีชมพู */
            border-radius: 4px;
            box-sizing: border-box;
        }
        ...
        input:focus, select:focus {
            outline: none;
            border-color: #d81b60; /* เปลี่ยนขอบเมื่อ focus เป็นสีชมพูเข้ม */
            box-shadow: 0 0 5px rgba(231, 30, 99, 0.3); /* เพิ่มเงาเมื่อ focus */
        }

        button {
            background-color: #e91e63; /* ปุ่มเป็นสีชมพู */
            color: white;
            padding: 10px 20px;
            border: none;
            border-radius: 4px;
        ...
        button:hover {
            background-color: #d81b60; /* สีชมพูเข้มเมื่อ hover */
...
![s3 2 2](https://github.com/user-attachments/assets/c3c85a08-9b71-4566-bcc6-69104b0577db)
...
![image](https://github.com/user-attachments/assets/f3da8305-8f67-46b2-94b4-b50ba5b3c177)
